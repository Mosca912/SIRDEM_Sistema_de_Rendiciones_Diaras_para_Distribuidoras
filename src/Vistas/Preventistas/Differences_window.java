...
public class Differences_window extends javax.swing.JFrame {
    ...
    //Tabla
    ModeloEditablePorFila differences_tablemod = new ModeloEditablePorFila(new String[]{ "S", "Fecha", "Saldo"}, 0) {
    ...
    public Differences_window(int empId) throws SQLException {
        initComponents();
        Differences_window.empId = empId;
        Clases.General_configurations.Icon(this);
        this.setLocationRelativeTo(null);
        Clases.General_configurations.MaxMinWindow(this);
        Clases.General_configurations.table_configuration(differences_table, differences_tablemod);
        Clases.Differences_window.ShowDifferencesGeneral(con, differences_tablemod, empId, differences_table, lbl_general, lbl_w1, lbl_w2, lbl_w3, lbl_w4);
        if (differences_table.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "¡No se encontró ninguna devolución!");
        }
    ...
    private void initComponents() {
        ...
        differences_table = new javax.swing.JTable();
        ...
        w1_panel = new javax.swing.JPanel();
        lbl_w1 = new javax.swing.JLabel();
        w2_panel = new javax.swing.JPanel();
        lbl_w2 = new javax.swing.JLabel();
        w2_panel1 = new javax.swing.JPanel();
        lbl_w3 = new javax.swing.JLabel();
        w2_panel2 = new javax.swing.JPanel();
        ...
        lbl_title.setText("DIFERENCIAS");

        differences_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(differences_table);
        ...
        general_panelLayout.setHorizontalGroup(
            ...
            .addComponent(lbl_general, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
        );
        ...
        w1_panel.setBackground(new java.awt.Color(255, 255, 204));
        w1_panel.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true), "Semana 1:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N

        lbl_w1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_w1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_w1.setText("0");
        lbl_w1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));

        javax.swing.GroupLayout w1_panelLayout = new javax.swing.GroupLayout(w1_panel);
        w1_panel.setLayout(w1_panelLayout);
        w1_panelLayout.setHorizontalGroup(
            w1_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_w1, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
        );
        w1_panelLayout.setVerticalGroup(
            w1_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_w1, javax.swing.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
        );

        w2_panel.setBackground(new java.awt.Color(255, 204, 204));
        w2_panel.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true), "Semana 2:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N

        lbl_w2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_w2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_w2.setText("0");

        javax.swing.GroupLayout w2_panelLayout = new javax.swing.GroupLayout(w2_panel);
        w2_panel.setLayout(w2_panelLayout);
        w2_panelLayout.setHorizontalGroup(
            w2_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_w2, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
        );
        w2_panelLayout.setVerticalGroup(
            w2_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_w2, javax.swing.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
        );

        w2_panel1.setBackground(new java.awt.Color(255, 153, 255));
        w2_panel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true), "Semana 3:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N

        lbl_w3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_w3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_w3.setText("0");

        javax.swing.GroupLayout w2_panel1Layout = new javax.swing.GroupLayout(w2_panel1);
        w2_panel1.setLayout(w2_panel1Layout);
        w2_panel1Layout.setHorizontalGroup(
            w2_panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_w3, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
        );
        w2_panel1Layout.setVerticalGroup(
            w2_panel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_w3, javax.swing.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
        );

        w2_panel2.setBackground(new java.awt.Color(204, 255, 255));
        w2_panel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 3, true), "Semana 4:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N

        lbl_w4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lbl_w4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_w4.setText("0");

        javax.swing.GroupLayout w2_panel2Layout = new javax.swing.GroupLayout(w2_panel2);
        w2_panel2.setLayout(w2_panel2Layout);
        w2_panel2Layout.setHorizontalGroup(
            w2_panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_w4, javax.swing.GroupLayout.DEFAULT_SIZE, 166, Short.MAX_VALUE)
        );
        w2_panel2Layout.setVerticalGroup(
            w2_panel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lbl_w4, javax.swing.GroupLayout.DEFAULT_SIZE, 52, Short.MAX_VALUE)
        );
            ...
            .addGroup(section_menuLayout.createSequentialGroup()
                ...
                .addGroup(section_menuLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(section_menuLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(w1_panel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(w2_panel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(w2_panel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(w2_panel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void products_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_products_buttonActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Differences_window.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
    ...
    private void month_cbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_month_cbActionPerformed
        ...
        if (indice != 0) {
            differences_tablemod.setRowCount(0);
            try {
                Clases.Differences_window.ShowDifferencesMonth(con, differences_tablemod, empId, differences_table, lbl_general, indice, lbl_w1, lbl_w2, lbl_w3, lbl_w4);
                if (differences_table.getRowCount() == 0) {
                    JOptionPane.showMessageDialog(null, "¡No se encontró ningún Gasto este mes!");
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "ERRROR: " + ex);
            }
        } else {
            differences_tablemod.setRowCount(0);
            try {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new Differences_window(0).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Differences_window.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JTable differences_table;
    ...
    private javax.swing.JPanel w1_panel;
    private javax.swing.JPanel w2_panel;
    private javax.swing.JPanel w2_panel1;
    private javax.swing.JPanel w2_panel2;

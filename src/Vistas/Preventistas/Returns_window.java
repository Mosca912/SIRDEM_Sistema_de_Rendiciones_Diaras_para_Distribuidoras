...
public class Returns_window extends javax.swing.JFrame {
    ...
    //Tabla
    ModeloEditablePorFila returns_tablemod = new ModeloEditablePorFila(new String[]{"S", "N/A", "Zona", "Saldo", "Fecha"}, 0) {
    ...
    public Returns_window(int empId) throws SQLException {
        initComponents();
        Returns_window.empId = empId;
        Clases.General_configurations.Icon(this);
        this.setLocationRelativeTo(null);
        Clases.General_configurations.MaxMinWindow(this);
        Clases.General_configurations.table_configuration(returns_table, returns_tablemod);
        Clases.Returns_window.ShowReturnsGeneral(con, returns_tablemod, empId, returns_table, lbl_general, lbl_w1, lbl_w2, lbl_w3, lbl_w4);
        if (returns_table.getRowCount() == 0) {
    ...
    private void initComponents() {
        ...
        returns_table = new javax.swing.JTable();
        ...
        lbl_title.setText("DEVOLUCIONES");

        returns_table.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(returns_table);
    ...
    private void products_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_products_buttonActionPerformed
        ...
        try {
            ...
            Logger.getLogger(Returns_window.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.dispose();
    ...
    private void month_cbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_month_cbActionPerformed
        ...
        if (indice != 0) {
            returns_tablemod.setRowCount(0);
            try {
                Clases.Returns_window.ShowReturnsMonth(con, returns_tablemod, empId, returns_table, lbl_general, indice, lbl_w1, lbl_w2, lbl_w3, lbl_w4);
                if (returns_table.getRowCount() == 0) {
                    JOptionPane.showMessageDialog(null, "¡No se encontró ningún Devolución este mes!");
                }
            } catch (SQLException ex) {
            ...
            try {
                Clases.Returns_window.ShowReturnsGeneral(con, returns_tablemod, empId, returns_table, lbl_general, lbl_w1, lbl_w2, lbl_w3, lbl_w4);
                if (returns_table.getRowCount() == 0) {
                    JOptionPane.showMessageDialog(null, "¡No se encontró ningún Devolución!");
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "ERRROR: " + ex);
            }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new Returns_window(0).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(Returns_window.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private javax.swing.JTable returns_table;
